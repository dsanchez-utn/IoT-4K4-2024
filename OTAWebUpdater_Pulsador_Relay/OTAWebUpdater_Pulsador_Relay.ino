...
const int pinRele = 4;   // Pin del Rele
int estadoRele = LOW;     // Estado del LED
...
void setup() {
  ...
  pinMode(pinRele, OUTPUT); // Configurar el pin del LED INTEGRADO como salida
